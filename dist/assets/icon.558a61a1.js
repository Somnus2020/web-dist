import{aD as c,cA as h,cB as e,cC as o,cD as p,cE as n,cF as i,cG as m,cH as f,cI as d,cJ as F,cK as v,cL as E,cM as M,cN as u,cO as H}from"./index.6c713c14.js";import{h as B,i as I,k as V,l as k}from"./index.bbb48087.js";import{I as x}from"./Layout.fb199198.js";import{a as A}from"./index.f2fff30b.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function D(a){return c({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>F`},a)}function O(a){return c({a:{viewBox:"0 0 48 48"},c:`<path d="M0 0h48v48H0z" fill="none"/>
      <path fill="#ffffff" d="M40 8H8c-2.21 0-4 1.79-4 4v24c0 2.21 1.79 4 4 4h32c2.21 0 4-1.79 4-4V12c0-2.21-1.79-4-4-4zM8 24h8v4H8v-4zm20 12H8v-4h20v4zm12 0h-8v-4h8v4zm0-8H20v-4h20v4z"/>`},a)}const z={"dmg,ipa,plist,tipa":f,"exe,msi":d,"zip,gz,rar,7z,tar,jar,xz":F,apk:x,db:B,md:v,epub:I,iso:V,m3u8:i,"doc,docx":E,"xls,xlsx":M,"ppt,pptx":u,pdf:H,psd:D,ai:L,url:k,cast:A},Z=(a,t)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(z))if(s.split(",").includes(t.toLowerCase()))return r}switch(a){case l.FOLDER:return m;case l.VIDEO:return i;case l.AUDIO:return n;case l.TEXT:return p;case l.IMAGE:return o;default:return e}},P=a=>Z(a.type,h(a.name));export{O as A,l as O,P as g};
